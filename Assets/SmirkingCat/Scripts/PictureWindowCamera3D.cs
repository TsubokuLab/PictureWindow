...
public class PictureWindowCamera3D : MonoBehaviour
{
    ...
    private void LateUpdate ()
    {
        ...
        if (PictureWindow3D.Instance.TopRight != null)
        {

            // Calculate the projection
            Matrix4x4 genProjection = GeneralizedPerspectiveProjection(PictureWindow3D.Instance.BottomLeft, PictureWindow3D.Instance.BottomRight, PictureWindow3D.Instance.TopLeft,
            ...
            _cam.transform.rotation = Quaternion.LookRotation(PictureWindow3D.Instance.WindowNormal);
    ...
    public static Matrix4x4 GeneralizedPerspectiveProjection(Vector3 bottomLeft, Vector3 bottomRight, Vector3 topLeft, Vector3 eye, float near, float far)
    {
        ...
        PictureWindow3D.Instance.WindowNormal = vn;
